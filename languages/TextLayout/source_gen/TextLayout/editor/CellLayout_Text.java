...
/**
 * based on the Jetbrains code from:
 * CellLayout_Indent.java and
 * PunctuationUtil.java
 */
public class CellLayout_Text extends AbstractCellLayout {
  /*package*/ static boolean isOnNewLine(EditorCell root, EditorCell cell) {
  ...
  public int getAscent(EditorCell_Collection editorCells) {
    ...
    int result = 0;
    for (EditorCell cell2 : editorCells) {
      result = cell2.getAscent();
      if (result > 0) {
        break;
      }
    }
  ...
  public void doLayout(EditorCell_Collection editorCells) {
    if (editorCells.getParent() != null && editorCells.getParent().getCellLayout() instanceof CellLayout_Text) {
      return;
    }
  ...
  public TextBuilder doLayoutText(Iterable<EditorCell> editorCells) {
    Set<EditorCell> editorCellsSet = SetSequence.fromSet(new HashSet<EditorCell>());
    for (EditorCell editorCell : editorCells) {
      SetSequence.fromSet(editorCellsSet).addElement(editorCell);
    }
    ...
    if (iterator.hasNext()) {
      ...
      for (EditorCell current : getIndentLeafs(rootCell)) {
        ...
        if (!(SetSequence.fromSet(editorCellsSet).contains(childCell))) {
          continue;
        }
  ...
  private static List<EditorCell> getIndentLeafs(EditorCell_Collection current) {
    ArrayList<EditorCell> result = new ArrayList();
  ...
  private static boolean isIndentCollection(EditorCell_Collection collection) {
    return collection.getCellLayout() instanceof CellLayout_Text && !(collection.isEmpty());
  }
  private class CellLayouter {
    ...
    private ArrayList<EditorCell> myLineContent = new ArrayList();
    private ArrayList<Integer> myLineWrapIndent = new ArrayList();
    ...
    private void splitLineAt(EditorCell splitAt) {
      ...
      withIndent(myLineIndent, myLineWrapIndent.get(index), new Runnable() {
        public void run() {
          resetLine();
          for (jetbrains.mps.nodeEditor.cells.EditorCell cell : oldLine) {
            appendCell(cell, cell == oldLine.get(oldLine.size() - 1));
          }
          if (!(oldLine.isEmpty())) {
            newLine(true);
          }
          for (jetbrains.mps.nodeEditor.cells.EditorCell cell : newLine) {
            appendCell(cell, false);
          }
        }
      });
  ...
  private static void addGaps(EditorCell cell, boolean skipLeft, boolean skipRight) {
    if (cell instanceof jetbrains.mps.nodeEditor.cells.EditorCell_Collection && (hasPunctuableLayout((jetbrains.mps.nodeEditor.cells.EditorCell_Collection) cell) || cell.getStyle().get(StyleAttributes.DRAW_BORDER))) {
      return;
    }
  ...
  private static int getLeftGap(EditorCell cell) {
  ...
  private static boolean hasRightGap(EditorCell currentCell) {
    return (!(rightCellHasPunctuationLeft(currentCell)) || currentCell.getStyle().get(StyleAttributes.DRAW_BORDER)) && !(hasPunctuationRight(currentCell));
  }

  public static boolean hasLeftGap(EditorCell currentCell) {
    return (!(leftCellHasPunctuationRight(currentCell)) || currentCell.getStyle().get(StyleAttributes.DRAW_BORDER)) && !(hasPunctuationLeft(currentCell));
  }
  ...
  private static boolean leftCellHasPunctuationRight(EditorCell currentCell) {
    ...
    if (leftCell instanceof jetbrains.mps.nodeEditor.cells.EditorCell_Collection) {
  ...
  private static int getHorizontalGap(EditorCell_Collection editorCells) {
    ...
    if (padding.getType() == Measure.PIXELS) {
      ...
      return (int) (padding.getValue() * EditorSettings.getInstance().getDefaultEditorFontMetrics().getWidth(" "));
    }
  }

  private static boolean hasPunctuableLayout(EditorCell_Collection collection) {
    return collection.getCellLayout() instanceof CellLayout_Horizontal || collection.getCellLayout() instanceof CellLayout_Text;
  }
